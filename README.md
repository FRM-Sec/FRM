...
### This repository is based on a fork of the repository of [Attack-Resistant Federated Learning with Residual-based Reweighting](https://github.com/fushuhao6/Attack-Resistant-Federated-Learning) at a [workshop of AAAI 21](https://federated-learning.org/rseml2021), a benchmark for residual based Federated Learning: Attack-Resistant Federated Learning with Residual-based Reweighting. Our NDSS'23 paper extends upon the code of AAAI in residual-based.
